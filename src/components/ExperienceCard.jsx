...
const ExperienceCard = (data) => {
  return (
    <Card sx={{ display: 'flex', flexDirection: {xs:"column-reverse",md:'row'}, width: "80vw", bgcolor: "#222", color: "#fff", boxShadow: "0px 0px 5px 3px rgb(50, 50, 45)", border: "2px solid rgb(89, 89, 65)" }}>
